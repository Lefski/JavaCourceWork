...
export const PersonalAccountPage = () => {
    ...
    const pagesForPublisher: IButton[] = [
        {style: 'nav-link', data: 'orders', component: <ItemsPage></ItemsPage>},
        // {style: 'nav-link', data: 'add order', component: <AddNewItem></AddNewItem>},
    ];
                ...
                data && <>
                    ...
                    <div className="mt-0 ms-4 me-4 mb-4">
                        {page === 'settings' ? <SettingsPage
                            ...
                            ></SettingsPage> :
                            page === 'orders' ? pagesForPublisher[0].component :
                                page === 'add order' ? pagesForPublisher[1].component :
